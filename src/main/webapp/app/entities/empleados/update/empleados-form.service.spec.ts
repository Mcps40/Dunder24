      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            nombre_empleado: expect.any(Object),
            apellido_empleado: expect.any(Object),
            telefono_empleado: expect.any(Object),
            correo_empleado: expect.any(Object),
            departamento: expect.any(Object),
            jefatura: expect.any(Object),
          }),
        );
      });
