...
import { sampleWithRequiredData } from '../jefaturas.test-samples';
import { JefaturasService } from '../service/jefaturas.service';

import { JefaturasComponent } from './jefaturas.component';
import SpyInstance = jest.SpyInstance;

describe('Jefaturas Management Component', () => {
  let comp: JefaturasComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(JefaturasComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.jefaturas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to jefaturasService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getJefaturasIdentifier');
      const id = comp.trackId(entity);
      expect(service.getJefaturasIdentifier).toHaveBeenCalledWith(entity);
